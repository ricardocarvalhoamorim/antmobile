...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String about = "<p>O ANT Mobile é uma aplicação para explorar recursos no sistema de informação da Univesridade do Porto. Foi desenvolvida " +
                ...
                " resolvam problemas do dia a dia, com uma pitada de bom design (que não é claramente o seu forte). Tem um fraquinho por chocolate" +
                " negro, e vibra com jantaradas e viagens. <br /><br />\n" +
                "   &#8226; <b>José Devezas(josedevezas.com)</b> Autor da plataforma ANT, o José tem uma grande experiência em processamento de informação, e consegue " +
                ...
                " qualquer empresa procura.<br /><br />\n" +
                "<p>São então estes os dois singelos programadores que decidiram pegar no problema do acesso a informações do SIGARRA (e da " +
                "inexistência de uma aplicação bonita o suficiente para este efeito) e tentar resolvê-lo. Ora, o ANT e o ANT Mobile são parte da " +
